...
The output adheres to McKinsey/BCG consulting voice standards. The report language needs to be in English only.
...
- Output reports in ENGLISH language with professional consulting tone
...
- **Language**: All headings and content has to be in English.
